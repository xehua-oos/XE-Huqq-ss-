-- ============================================================
-- 坤坤大帝脚本 最终稳定版（无自定义背景，仅保留核心功能+修复）
-- 包含：WindUI 边框设置 + 通用 + 变身 + 第二个脚本全部功能
-- 修复：自瞄 FOV 圆圈在每次渲染时自动重建，确保永不消失
-- ============================================================
...
local Window = WindUI:CreateWindow({
    Title = "<font color='#FFA500'>坤坤大帝</font><font color='#FFFF00'>Hub 最终稳定版</font>",
...
Window:Tag({ Title = "最终稳定版", Color = Color3.fromHex("#0000FF") })
...
-- ===================== 启动完成通知 =====================
Notify("坤坤大帝脚本", "最终稳定版加载成功！所有功能已修复，自瞄圆圈永不消失。", 5)
